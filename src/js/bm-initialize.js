...
var banManagerCheckInit = function() {
    if (typeof jQuery === 'undefined') {
        setTimeout(banManagerCheckInit, 100);
    } else {
        banManagerInit(jQuery);
    }
};
